...
@Component({
    selector: 'team-loc',
    templateUrl: './team-loc.component.html',
    styleUrls: ['./team-loc.component.css']
})

export class TeamLoCComponent {
    fromYear : number;
    fromMonth : number;
    fromDay : number;
    ...
    onDateRangeChanged(event: IMyDateRangeModel) {
        this.router.navigate(['/team/loc/' + event.beginDate.year + '/' + event.beginDate.month + '/' + event.beginDate.day + '/to/' + event.endDate.year + '/' + event.endDate.month + '/' + event.endDate.day]);
        ...
        this.qs.teamExternalData(this.userService, date).subscribe((result) => {
            ...
            Object.keys(result.data).forEach(function(c) {
                ...
                ret.push({
                    ...
                    points: result.data[c].LinesOfCode
                });
            });
