...
@Component({
    selector: 'team-commits',
    templateUrl: './team-commits.component.html',
    styleUrls: ['./team-commits.component.css']
})

export class TeamCommitsComponent {
    fromYear : number;
    fromMonth : number;
    fromDay : number;
    ...
    onDateRangeChanged(event: IMyDateRangeModel) {
        this.router.navigate(['/team/commits/' + event.beginDate.year + '/' + event.beginDate.month + '/' + event.beginDate.day + '/to/' + event.endDate.year + '/' + event.endDate.month + '/' + event.endDate.day]);
